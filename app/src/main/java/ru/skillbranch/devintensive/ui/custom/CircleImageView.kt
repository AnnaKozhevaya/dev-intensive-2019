...
class CircleImageView : ImageView {
    ...
    private fun getBitmapFromDrawable(drawable: Drawable?): Bitmap? {
        ...
        try {
            val bitmap = when (drawable is ColorDrawable) {
                true -> Bitmap.createBitmap(COLORDRAWABLE_DIMENSION, COLORDRAWABLE_DIMENSION, BITMAP_CONFIG)
                false -> Bitmap.createBitmap(drawable.intrinsicWidth, drawable.intrinsicHeight, BITMAP_CONFIG)
            }
